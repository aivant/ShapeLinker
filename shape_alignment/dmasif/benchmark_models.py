...
from shape_alignment.dmasif.benchmark_layers import MyDynamicEdgeConv, MyXConv
from shape_alignment.dmasif.geometry_processing import dMaSIFConv, mesh_normals_areas, tangent_vectors
from shape_alignment.dmasif.helper import diagonal_ranges
...
class PointNet2_seg(torch.nn.Module):
    def __init__(self, in_channels, out_channels, radius, n_layers):
