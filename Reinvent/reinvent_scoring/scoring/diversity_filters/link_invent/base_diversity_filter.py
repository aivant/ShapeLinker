...
from reinvent_scoring.scoring.diversity_filters.link_invent.diversity_filter_memory import DiversityFilterMemory
from reinvent_scoring.scoring.diversity_filters.link_invent.diversity_filter_parameters import DiversityFilterParameters
...
class BaseDiversityFilter(abc.ABC):
    ...
    def _add_to_memory(self, indx: int, score, smile, scaffold, linker, input, components: List, step):
        self._diversity_filter_memory.update(indx, score, smile, scaffold, linker, input, components, step)
